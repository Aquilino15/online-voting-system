  ...
  <main class="flex-1 p-8 ">
    ...
    <div class="bg-white rounded-2xl shadow p-10 max-w-lg mx-auto">
      <div class="flex flex-col items-center space-y-4">
        <span class="material-icons text-blue-500 text-5xl"><i class="fa-solid fa-hourglass"></i></span>
        <h2 class="text-xl font-semibold text-gray-800">No Results Available Yet</h2>
        <p class="text-gray-600">
          The election period has not started or is currently ongoing.  
          Results will be displayed here once the voting process has been completed.
        </p>
      </div>
    </div>

    <p class="text-gray-500 text-sm mt-10 pt-40 text-center">
      ⚠️ Please check back after the official election has concluded.
    </p>
