...
<body class="bg-blue-50 min-h-screen flex">
  ...
  <aside class="w-64 bg-blue-100 min-h-screen p-6 flex flex-col justify-between shadow-lg">
    <div>
      ...
      <nav class="space-y-4">
        ...
        <a href="/user_vote" class="flex items-center space-x-3 text-white bg-blue-600 p-3 rounded-xl">
  ...
  <main class="flex-1 p-8">
    <h1 class="text-2xl font-bold mb-4">🗳 Voting Section</h1>
    <!--
    <p class="text-gray-600 mb-8">
      Leyte Normal University — Student Council Election
    </p>-->

    <!-- Placeholder Card -->
    <div class="bg-white rounded-2xl shadow p-10 max-w-lg mx-auto">
      <div class="flex flex-col items-center space-y-4">
        <span class="material-icons text-blue-500 text-5xl"><i class="fa-solid fa-calendar-days"></i></span>
        <h2 class="text-xl font-semibold text-gray-800">Voting Is Not Yet Available</h2>
        <p class="text-gray-600">
          The voting period has not started yet.  
          Please check back once the election officially begins.
        </p>
      </div>
    </div>

    <p class="text-gray-500 text-sm mt-10 text-center pt-40">
      🕒 You will be able to cast your vote here once the election is open.
    </p>
  </main>
